...
The scope available to nestedFunction is all functions that nestedFunction is in and global scope located above nestedFunction.
*/
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(arr){
    return arr.filter(arr => arr.population < 5);
  }
  ...
  */
  ...
  function USApop(arr){
    return arr.reduce((total, arr) => {return total += arr.population},0);
  }
